...
export const api = {
  ...
  caixinha: {
    ...
    list: () => fetchAPI("/caixinha"),

    update: (id: string, data: unknown) =>
      fetchAPI(`/caixinha/${id}`, {
        method: "PUT",
        body: JSON.stringify(data),
      }),
    ...
    createMovimentacao: (data: unknown) =>
      fetchAPI("/movimentacao-caixinha", {
        method: "POST",
        body: JSON.stringify(data),
      }),

    listMovimentacoes: (caixinhaId: string) =>
      fetchAPI(`/movimentacao-caixinha/${caixinhaId}`),

    deleteMovimentacao: (caixinhaId: string, movId: string) =>
      fetchAPI(`/movimentacao-caixinha/${caixinhaId}/${movId}`, {
        method: "DELETE",
      }),
  },
  ...
  limparDadosOrfaos: () =>
    fetchAPI("/limpar-dados-orfaos", {
      method: "POST",
    }),

  // Debug
  debugDividasPessoas: () =>
    fetchAPI("/debug/dividas-pessoas"),
};
