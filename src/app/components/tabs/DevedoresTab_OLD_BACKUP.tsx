...
export function DevedoresTab() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      {/* Dialog para excluir pessoa com dívidas vinculadas */}
      <Dialog open={deletePessoaWithDebtsDialogOpen} onOpenChange={setDeletePessoaWithDebtsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Pessoa possui dívidas vinculadas</DialogTitle>
            <DialogDescription>
              Esta pessoa possui {pessoaDividasCount} {pessoaDividasCount === 1 ? "dívida vinculada" : "dívidas vinculadas"}.
          ...
          <div className="py-4 space-y-2">
            <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-md">
              <p className="text-sm text-yellow-800">
                <strong>Atenção:</strong> Se você remover os vínculos, as dívidas serão mantidas mas
                esta pessoa será removida delas. Se houver outras pessoas vinculadas às dívidas,
                elas permanecerão.
              </p>
            </div>
          </div>
          <DialogFooter className="flex-col sm:flex-col gap-2">
            <Button onClick={() => confirmDeletePessoa(true)} variant="destructive" className="w-full">
              Remover vínculos e excluir pessoa
            </Button>
            <Button
              variant="outline"
              onClick={() => {
                setDeletePessoaWithDebtsDialogOpen(false);
                setPessoaToDelete(null);
                setPessoaDividasCount(0);
              }}
              className="w-full"
            >
              Cancelar exclusão
      ...
      {/* Dialog para excluir pessoa sem dívidas */}
      <Dialog open={deletePessoaDialogOpen} onOpenChange={setDeletePessoaDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button variant="destructive" onClick={() => confirmDeletePessoa(false)}>
              Excluir
            </Button>
          </DialogFooter>
        </DialogContent>
