...
import { Plus, ShoppingCart, CreditCard, Edit, Trash2, ArrowLeft, DollarSign } from "lucide-react";
...
export function GastosTab() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (parcelaAtual > totalParcelas) {
      toast.error("Número da parcela não pode ser maior que o total de parcelas");
      return;
    }
  ...
  const handleEditSubmit = async () => {
    ...
    if (isNaN(novaParcela) || novaParcela < 1 || novaParcela > parcelaToEdit.total_parcelas) {
      toast.error(`Número da parcela deve estar entre 1 e ${parcelaToEdit.total_parcelas}`);
      return;
    }
                      ...
                      <CardContent className="pt-6">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between items-center pt-2 border-t border-gray-200">
                            ...
                            <span className="font-bold text-lg text-green-600">{formatCurrency(totalFatura)}</span>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {parcelaToEdit && (
                <>
                  Altere o valor da parcela de <strong>{parcelaToEdit.compra_descricao}</strong>
                </>
              )}
            </DialogDescription>
          </DialogHeader>
            ...
            {parcelaToEdit && (
              <>
                <div className="bg-gray-50 p-3 rounded-md">
                  <p className="text-sm text-gray-600">Informações da parcela</p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">
                      Valor original: {formatCurrency(parcelaToEdit.valor)}
                    </p>
                  </div>
                  <div>
